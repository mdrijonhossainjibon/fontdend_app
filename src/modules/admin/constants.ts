...
export const CLEAR_ADMIN_USERS_REQUEST = 'CLEAR_ADMIN_USERS_REQUEST';
export const CLEAR_ADMIN_USERS_SUCCESS = 'CLEAR_ADMIN_USERS_SUCCESS';
export const CLEAR_ADMIN_USERS_FAILURE = 'CLEAR_ADMIN_USERS_FAILURE';
